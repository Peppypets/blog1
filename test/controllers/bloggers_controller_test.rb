...
class BloggersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blogger" do
    assert_difference('Blogger.count') do
      post bloggers_url, params: { blogger: { emailaddr: @blogger.emailaddr, name: @blogger.name, rank: @blogger.rank } }
    end
  ...
  test "should update blogger" do
    patch blogger_url(@blogger), params: { blogger: { emailaddr: @blogger.emailaddr, name: @blogger.name, rank: @blogger.rank } }
